<template>
  <!-- <div class="layout-content E404"> -->

  <div class="root body--ready">
    <canvas class="canvas" width="1820" height="905"></canvas>
    <p class="text">
      <!-- <div class="layout-content E404"> -->
      <router-link to="/">回到模块首页</router-link>

      <!-- <div>{{this.$router.history.current.redirectedFrom}}</div> -->
      <!-- </div> -->
    </p>
  </div>
...
.body--ready {
  background: linear-gradient(to top, rgb(203, 235, 219) 0%, rgb(55, 148, 192) 120%);
}
