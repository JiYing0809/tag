...
var allRouters = require('../src/router')
    ...
    new CopyWebpackPlugin([
      {
        ...
        from:path.resolve(__dirname,'../src/router.js'),
        to: config.dist.assetsSubDirectory+'/router',
        toType: 'file',
        transform:function(content,path){
          return `"${config.base.name}":`+JSON.stringify(Object.keys(allRouters).reduce((pre,cur)=>allRouters[pre].concat(allRouters[cur])))
        }
      }
    ])
  ]
